        ...
        public boolean onTouch(final View v, MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (paddingRect == null) {
                        paddingRect = new Rect(SizeUtils.dp2px(10), SizeUtils.dp2px(20), SizeUtils.dp2px(10),
                                SizeUtils.dp2px(70));
                    }
                    ...
                    } else if (x - inX + v.getWidth() >= ScreenUtils.getScreenWidth() - paddingRect.right) {
                        destX = ScreenUtils.getScreenWidth() - v.getWidth() - paddingRect.right;
                    } else {
                        destX = x - inX;
                    }
                    ...
                    } else if (y - inY + v.getHeight() >= ScreenUtils.getScreenHeight() - paddingRect.bottom) {
                        destY = ScreenUtils.getScreenHeight() - v.getHeight() - paddingRect.bottom;
                    } else {
                        destY = y - inY;
                    }
